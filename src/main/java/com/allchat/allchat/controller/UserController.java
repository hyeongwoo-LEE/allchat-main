...
public class UserController {
    ...
    public void kakaoCallback(@RequestParam("code") String code) throws JsonProcessingException {
        ...
        if(userRepository.findByUsername(kakaoUserSignupDTO.getUsername() + " kakao").isEmpty()){
            log.info("신입 회원입니다.");
